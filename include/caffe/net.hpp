...
class Net {
 public:
  ...
  inline vector<string>& params_lr_policy() {return params_lr_policy_; }
  ...
  // per layer loss
  inline vector<float>& layer_loss() {return layer_loss_;}
 protected:
